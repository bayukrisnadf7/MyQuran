...
const Page = async ({ params }) => {
  ...
  return (
    <>
      <Navbar />
      <div>
        <Pagination next={nextSurah} surahPrevious={previousSurah.data.name?.transliteration.id} surahNext={nextSurah.data.name?.transliteration.id} previous={previousSurah} />
